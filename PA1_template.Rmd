...
The mean number of total steps taken per day is found to be `r rmean`.
The median of the total number of steps taken per day is `r rmedian`.
...
````  
The interval with the highest number of average steps is `r rinterval`.  
...
The number of rows with missing values is `r rna.rows`.  
...
The mean and median total number of steps taken per day are `r dmean` and `r dmedian` respectively. The differences between the estimates from the first part of the assignment and the estimates from the second part of data are `r dmean` and `r dmedian` respectively.  
